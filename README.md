...
This repository provides an F# [WebSharper](https://websharper.com/) binding for the [WebGPU API](https://developer.mozilla.org/en-US/docs/Web/API/WebGPU_API), enabling seamless integration of GPU-accelerated graphics and computation into WebSharper projects.
